        ...
        <div className='grid md:grid-cols-2 gap-16 lg:gap-24'>
          ...
          <div>
            ...
            <div className='space-y-8'>
              {jobSeekerFeatures.map((feature, index) => (
                ...
                >
                  <div className='flex-shrink-0 w-12 h-12 flex rounded-xl items-center justify-center group-hover:bg-blue-200 transition-colors duration-300 bg-blue-100'>
          ...
          <div>
            <div className='text-center mb-12'>
              ...
              <div className='w-24 h-1 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full mx-auto' />
            ...
            <div className='space-y-8'>
              {employerFeatures.map((feature, index) => (
                ...
                >
                  <div className='flex-shrink-0 w-12 h-12 flex rounded-xl items-center justify-center group-hover:bg-purple-200 transition-colors duration-300 bg-purple-100'>
